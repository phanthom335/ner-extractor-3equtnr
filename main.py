    """
    Ner Extractor 3equtnr
    =====================
    Open-source NLP tool built to classify text data with state-of-the-art techniques.
    ...
    APP_NAME    = "Ner Extractor 3equtnr"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source NLP tool built to classify text data with state-of-the-art techniques.")
